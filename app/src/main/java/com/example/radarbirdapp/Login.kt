package com.example.radarbirdapp // Replace with your package name
        ...
        auth.signInWithEmailAndPassword(email, password)
            .addOnCompleteListener(this) { task ->
                if (task.isSuccessful) {
                    ...
                    val intent = Intent(this, Home::class.java) // Replace DashboardActivity with your next activity class
